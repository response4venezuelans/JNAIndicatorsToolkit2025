...
framework <- tabPanel(title = "Marco Analítico",
                      ...
                      div(column(
                        width = 12,
                        HTML(
                          "<iframe src='https://flo.uri.sh/visualisation/17451564/embed'
                          ...
                          href='https://public.flourish.studio/visualisation/17451564/?utm_source=embed&utm_campaign=visualisation/17451564' 
